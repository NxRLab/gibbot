...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/PrimaryV6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=ADC.c debug.c encoder.c I2CMaster.c motor.c MPU.c test.c UART.c initializeV6.c mainV6.c Temperature.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ADC.o ${OBJECTDIR}/debug.o ${OBJECTDIR}/encoder.o ${OBJECTDIR}/I2CMaster.o ${OBJECTDIR}/motor.o ${OBJECTDIR}/MPU.o ${OBJECTDIR}/test.o ${OBJECTDIR}/UART.o ${OBJECTDIR}/initializeV6.o ${OBJECTDIR}/mainV6.o ${OBJECTDIR}/Temperature.o
POSSIBLE_DEPFILES=${OBJECTDIR}/ADC.o.d ${OBJECTDIR}/debug.o.d ${OBJECTDIR}/encoder.o.d ${OBJECTDIR}/I2CMaster.o.d ${OBJECTDIR}/motor.o.d ${OBJECTDIR}/MPU.o.d ${OBJECTDIR}/test.o.d ${OBJECTDIR}/UART.o.d ${OBJECTDIR}/initializeV6.o.d ${OBJECTDIR}/mainV6.o.d ${OBJECTDIR}/Temperature.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ADC.o ${OBJECTDIR}/debug.o ${OBJECTDIR}/encoder.o ${OBJECTDIR}/I2CMaster.o ${OBJECTDIR}/motor.o ${OBJECTDIR}/MPU.o ${OBJECTDIR}/test.o ${OBJECTDIR}/UART.o ${OBJECTDIR}/initializeV6.o ${OBJECTDIR}/mainV6.o ${OBJECTDIR}/Temperature.o

# Source Files
SOURCEFILES=ADC.c debug.c encoder.c I2CMaster.c motor.c MPU.c test.c UART.c initializeV6.c mainV6.c Temperature.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/PrimaryV6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/test.o: test.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/test.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  test.c  -o ${OBJECTDIR}/test.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/test.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
...
${OBJECTDIR}/initializeV6.o: initializeV6.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/initializeV6.o.d 
	@${RM} ${OBJECTDIR}/initializeV6.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  initializeV6.c  -o ${OBJECTDIR}/initializeV6.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/initializeV6.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/initializeV6.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/mainV6.o: mainV6.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/mainV6.o.d 
	@${RM} ${OBJECTDIR}/mainV6.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  mainV6.c  -o ${OBJECTDIR}/mainV6.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/mainV6.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/mainV6.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/initializeV6.o: initializeV6.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/initializeV6.o.d 
	@${RM} ${OBJECTDIR}/initializeV6.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  initializeV6.c  -o ${OBJECTDIR}/initializeV6.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/initializeV6.o.d"      -g -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/initializeV6.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/mainV6.o: mainV6.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/mainV6.o.d 
	@${RM} ${OBJECTDIR}/mainV6.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  mainV6.c  -o ${OBJECTDIR}/mainV6.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/mainV6.o.d"      -g -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/mainV6.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/PrimaryV6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/PrimaryV6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -Wl,--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--heap=2056,--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/PrimaryV6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/PrimaryV6.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -Wl,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--heap=2056,--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/PrimaryV6.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf 
