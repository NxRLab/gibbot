...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/PrimaryV5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=mainV5.c initializeV5.c motor.c UART.c debug.c test.c encoder.c ADC.c I2CMaster.c MPU.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/mainV5.o ${OBJECTDIR}/initializeV5.o ${OBJECTDIR}/motor.o ${OBJECTDIR}/UART.o ${OBJECTDIR}/debug.o ${OBJECTDIR}/test.o ${OBJECTDIR}/encoder.o ${OBJECTDIR}/ADC.o ${OBJECTDIR}/I2CMaster.o ${OBJECTDIR}/MPU.o
POSSIBLE_DEPFILES=${OBJECTDIR}/mainV5.o.d ${OBJECTDIR}/initializeV5.o.d ${OBJECTDIR}/motor.o.d ${OBJECTDIR}/UART.o.d ${OBJECTDIR}/debug.o.d ${OBJECTDIR}/test.o.d ${OBJECTDIR}/encoder.o.d ${OBJECTDIR}/ADC.o.d ${OBJECTDIR}/I2CMaster.o.d ${OBJECTDIR}/MPU.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/mainV5.o ${OBJECTDIR}/initializeV5.o ${OBJECTDIR}/motor.o ${OBJECTDIR}/UART.o ${OBJECTDIR}/debug.o ${OBJECTDIR}/test.o ${OBJECTDIR}/encoder.o ${OBJECTDIR}/ADC.o ${OBJECTDIR}/I2CMaster.o ${OBJECTDIR}/MPU.o

# Source Files
SOURCEFILES=mainV5.c initializeV5.c motor.c UART.c debug.c test.c encoder.c ADC.c I2CMaster.c MPU.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/PrimaryV5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/PrimaryV5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/PrimaryV5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -Wl,--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--heap=2056,--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/PrimaryV5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/PrimaryV5.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -Wl,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--heap=2056,--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/PrimaryV5.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf 
