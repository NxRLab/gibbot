...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/A_D_Conv.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
OBJECTFILES_QUOTED_IF_SPACED="${OBJECTDIR}/ADC test.o"
POSSIBLE_DEPFILES="${OBJECTDIR}/ADC test.o.d"

# Object Files
OBJECTFILES=${OBJECTDIR}/ADC\ test.o
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/ADC\ test.o: ADC\ test.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/ADC\ test.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE)  "ADC test.c"  -o "${OBJECTDIR}/ADC test.o"  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/ADC test.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/ADC test.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
else
${OBJECTDIR}/ADC\ test.o: ADC\ test.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/ADC\ test.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE)  "ADC test.c"  -o "${OBJECTDIR}/ADC test.o"  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/ADC test.o.d"      -g -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/ADC test.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
